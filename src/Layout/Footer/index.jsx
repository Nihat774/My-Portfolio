    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="mt-4 flex justify-center space-x-6">
          ...
          >
            <abbr title="Linkedin"><FaLinkedin size={24} /> </abbr>
          </Link>
          <Link
            to="https://github.com"
            target="_blank"
          ...
          >
           <abbr title="Github"><FaGithub size={24} /></abbr>  
          </Link>
          <Link
          ...
          >
            <abbr title="Instagram"><FaInstagram size={24} /></abbr>
          </Link>
          <Link
          ...
          >
            <abbr title="Whatsapp"><FaWhatsapp size={24} /></abbr> {/* WhatsApp iconu */}
          </Link>
        </div>
      </div>
    </footer>
